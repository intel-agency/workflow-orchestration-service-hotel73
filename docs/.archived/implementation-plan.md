...
>
> **Scope:** Template repo `workflow-orchestration-service-hotel73` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
